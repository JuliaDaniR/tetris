/*Se va a encargar de representar el modelo del tablero de juego y su nombre empieza con mayuscula para identificar que es una clase*/
class Tablero {
  constructor() {
    this.columnas = 10;
    this.filas = 20;
  ...
  /* La coordenada es una transformacion no lineal donde se aplica un escalamiento (multiplicacion) para el ajuste de las medidas y una translacion (suma) para el ajuste de las posiciones, en este caso, no usaremos rotaciones, no se necesita*/
  coordenada(x, y) {
